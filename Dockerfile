...
LABEL org.opencontainers.image.source="https://github.com/srinivasa97/dbgpt2"
 
# ---- Install envsubst (from gettext-base) ----
# Required by docker-entrypoint.sh to substitute env vars into config at startup
